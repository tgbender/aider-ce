...
from cecli.args_formatter import (
    DotEnvFormatter,
...
def get_parser(default_config_files, git_root):
    parser = configargparse.ArgumentParser(
        description="cecli is AI pair programming in your terminal",
    ...
    group.add_argument(
        ...
        help="Specify a file with cecli model settings for unknown models",
    ).complete = shtab.FILE
    group.add_argument(
        "--model-metadata-file",
    ...
    group.add_argument(
        ...
        default=".cecli.model.overrides.yml",
        help=(
    ...
    group.add_argument(
        ...
        default=".",
        help=(
            "Directory for the repository map cache .cecli.tags.cache.v#"
    ...
    default_input_history_file = (
        os.path.join(git_root, ".cecli/input.history") if git_root else ".cecli/input.history"
    )
    default_chat_history_file = (
        os.path.join(git_root, ".cecli/chat.history") if git_root else ".cecli/chat.history"
    )
    group.add_argument(
        "--input-history-file",
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Enable/disable adding .cecli* to .gitignore (default: True)",
    )
    group.add_argument(
        "--add-gitignore-files",
        action=argparse.BooleanOptionalAction,
    ...
    group.add_argument(
        ...
        default=None,
        help=(
            "Attribute cecli code changes in the git author name (default: True). If explicitly set"
    ...
    group.add_argument(
        ...
        default=None,
        help=(
            "Attribute cecli commits in the git committer name (default: True). If explicitly set"
            " to True, overrides --attribute-co-authored-by precedence for cecli edits."
        ),
    )
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix commit messages with 'cecli: ' if cecli authored the changes (default: False)",
    )
    group.add_argument(
        "--attribute-commit-message-committer",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix all commit messages with 'cecli: ' (default: False)",
    )
    group.add_argument(
        ...
        default=True,
        help=(
            "Attribute cecli edits using the Co-authored-by trailer in the commit message"
    ...
    group.add_argument(
        "--check-update",
        action=argparse.BooleanOptionalAction,
        help="Check for new cecli versions on launch",
        default=False,
    )
    group.add_argument(
        "--show-release-notes",
    ...
    group.add_argument(
        ...
        "--update",
        action="store_true",
        help="Upgrade cecli to the latest version from PyPI",
        default=False,
    )
    group.add_argument(
        "--version",
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Enable automatic copy/paste of chat between cecli and web UI (default: False)",
    )
    group.add_argument(
        "--apply",
        metavar="FILE",
